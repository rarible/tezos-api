...
data class Asset(
    ...
    @JsonSubTypes(
        ...
        JsonSubTypes.Type(value = COLLECTION::class, name = COLLECTION_NAME)
    )
    ...
    data class COLLECTION(val assetClass: String = COLLECTION_NAME, val contract: String) : AssetType()
