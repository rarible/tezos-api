...
class TokensApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    fun tokensGetTokenBalances(
        id: IntParameter?,
        account: AccountParameter?,
        tokenId: IntParameter?,
        tokenContract: AccountParameter?,
        tokenTokenId: NatParameter?,
        tokenStandard: TokenStandardParameter?,
        tokenMetadata: JsonParameter?,
        tokenHasFilters: kotlin.Boolean?,
        balance: NatParameter?,
        firstLevel: IntParameter?,
        firstTime: TimestampParameter?,
        lastLevel: IntParameter?,
        ...
        val localVarResponse = tokensGetTokenBalancesWithHttpInfo(
            id = id,
            account = account,
            tokenId = tokenId,
            ...
            tokenHasFilters = tokenHasFilters,
            balance = balance,
    ...
    fun tokensGetTokenBalances2(
        ...
        val localVarResponse = tokensGetTokenBalances2WithHttpInfo(
            level = level,
            account = account,
            tokenId = tokenId,
            tokenContract = tokenContract,
    ...
    fun tokensGetTokenBalancesCount(
        ...
        val localVarResponse = tokensGetTokenBalancesCountWithHttpInfo(
            id = id,
            account = account,
            tokenId = tokenId,
            tokenContract = tokenContract,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun tokensGetTokenBalancesCountWithHttpInfo(
        id: IntParameter?,
        account: AccountParameter?,
        tokenId: IntParameter?,
        tokenContract: AccountParameter?,
        ...
        val localVariableConfig = tokensGetTokenBalancesCountRequestConfig(
            id = id,
            account = account,
            tokenId = tokenId,
            tokenContract = tokenContract,
     ...
     * @return RequestConfig
     */
    fun tokensGetTokenBalancesCountRequestConfig(
        id: IntParameter?,
        account: AccountParameter?,
        tokenId: IntParameter?,
        tokenContract: AccountParameter?,
    ...
    fun tokensGetTokenTransfers(
        ...
        tokenHasFilters: kotlin.Boolean?,
        anyof: kotlin.String?,
        from: AccountParameter?,
        to: AccountParameter?,
        amount: NatParameter?,
        transactionId: IntParameter?,
        originationId: IntParameter?,
        migrationId: IntParameter?,
        sort: SortParameter?,
        offset: OffsetParameter?,
        limit: kotlin.Int?,
        select: SelectionParameter?
    ): kotlin.collections.List<TokenTransfer> {
        val localVarResponse = tokensGetTokenTransfersWithHttpInfo(
            id = id,
            level = level,
            timestamp = timestamp,
            tokenId = tokenId,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun tokensGetTokenTransfersWithHttpInfo(
        id: IntParameter?,
        level: IntParameter?,
        timestamp: TimestampParameter?,
        tokenId: IntParameter?,
        ...
        val localVariableConfig = tokensGetTokenTransfersRequestConfig(
            id = id,
            level = level,
            timestamp = timestamp,
            tokenId = tokenId,
     ...
     * @return RequestConfig
     */
    fun tokensGetTokenTransfersRequestConfig(
        id: IntParameter?,
        level: IntParameter?,
        timestamp: TimestampParameter?,
        tokenId: IntParameter?,
    ...
    fun tokensGetTokenTransfersCount(
        id: IntParameter?,
        level: IntParameter?,
        timestamp: TimestampParameter?,
        tokenId: IntParameter?,
        ...
        val localVarResponse = tokensGetTokenTransfersCountWithHttpInfo(
            id = id,
            level = level,
            timestamp = timestamp,
            tokenId = tokenId,
    ...
    fun tokensGetTokens(
        id: IntParameter?,
        contract: AccountParameter?,
        tokenId: NatParameter?,
        standard: TokenStandardParameter?,
        firstLevel: IntParameter?,
        firstTime: TimestampParameter?,
        lastLevel: IntParameter?,
        lastTime: TimestampParameter?,
        metadata: JsonParameter?,
        sort: SortParameter?,
        offset: OffsetParameter?,
        limit: kotlin.Int?,
        select: SelectionParameter?
    ): kotlin.collections.List<Token> {
        val localVarResponse = tokensGetTokensWithHttpInfo(
            id = id,
            contract = contract,
            tokenId = tokenId,
            standard = standard,
    ...
    fun tokensGetTokensWithHttpInfo(
        ...
        val localVariableConfig = tokensGetTokensRequestConfig(
            id = id,
            contract = contract,
            tokenId = tokenId,
            standard = standard,
     ...
     * @return RequestConfig
     */
    fun tokensGetTokensRequestConfig(
        id: IntParameter?,
        contract: AccountParameter?,
        tokenId: NatParameter?,
        standard: TokenStandardParameter?,
    ...
    fun tokensGetTokensCount(
        ...
        val localVarResponse = tokensGetTokensCountWithHttpInfo(
            id = id,
            contract = contract,
            tokenId = tokenId,
            standard = standard,
    ...
    fun tokensGetTokensCountWithHttpInfo(
        ...
        val localVariableConfig = tokensGetTokensCountRequestConfig(
            id = id,
            contract = contract,
            tokenId = tokenId,
            standard = standard,
     ...
     * @return RequestConfig
     */
    fun tokensGetTokensCountRequestConfig(
        id: IntParameter?,
        contract: AccountParameter?,
        tokenId: NatParameter?,
        standard: TokenStandardParameter?,
